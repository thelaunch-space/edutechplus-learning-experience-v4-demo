...
```json
{
  ...
  "postConversation": {
    "script": null,
    "question": "If a pizza has 4 equal slices, what do we call ONE slice?",
    "correctnessFilter": "one fourth|quarter|1/4|one-fourth|a fourth",
    "scaffolding": {
      "probes": [
        "Fractions have special names! When there are 4 pieces, what's ONE called?",
        "Think about the number FOUR. Each piece is a 'fourth'. So one of them is...?",
        "One piece out of four. The fraction name starts with 'one-f...'",
        "The word is one-FOURTH. Can you say that?",
        "It's one-fourth! Or you can say 'one quarter'. Great job!"
      ]
    },
